...
public class EditLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Trimodal");
		...
		driver.findElement(By.id("createLeadForm_description")).sendKeys("I know selenium");
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("priya821997@gmail.com");
